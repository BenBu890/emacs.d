...
(defun org-agenda-show-agenda-and-todo (&optional arg)
  ...
  (interactive "P")
  (org-agenda arg "n"))
(setq org-directory "c:/work/dropbox/git/org")
(setq org-default-notes-file "c:/work/dropbox/git/org/refile.org")
...
(setq org-capture-templates
      (quote (("t" "todo" entry (file "c:/work/dropbox/git/org/refile.org")
               "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
              ;; ("r" "respond" entry (file "c:/work/dropbox/git/org/refile.org")
              ;;  "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
              ("n" "note" entry (file "c:/work/dropbox/git/org/refile.org")
               "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
              ("j" "Journal" entry (file+datetree "c:/work/dropbox/git/org/diary.org")
               "* %?\n%U\n" :clock-in t :clock-resume t)
              ;; ("w" "org-protocol" entry (file "c:/work/dropbox/git/org/refile.org")
              ;;  "* TODO Review %c\n%U\n" :immediate-finish t)
              ;; ("m" "Meeting" entry (file "c:/work/dropbox/git/org/refile.org")
              ;;  "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
              ;; ("p" "Phone call" entry (file "c:/work/dropbox/git/org/refile.org")
              ;;  "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
              ("h" "Habit" entry (file "c:/work/dropbox/git/org/refile.org")
